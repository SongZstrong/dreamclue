 ...
 * @param url - The URL that might contain a locale prefix (e.g., /zh/docs/symbols or /docs/dream-symbols)
 * @param locale - The current locale to use
 * @returns The normalized URL with current locale prefix and .mdx extension (e.g., /en/docs/dream-symbols.mdx)
 */
