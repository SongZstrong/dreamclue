...
export default function FAQsThree() {
    const faqItems: FAQItem[] = [
        ...
        },
        {
            id: 'item-3',
            icon: 'truck',
            question: 'Can I get a faster interpretation?',
            answer: 'Yes. Short entries can be interpreted quickly, and richer notes can be expanded later with symbols, mood, and waking-life context.',
        },
        {
            id: 'item-4',
            icon: 'globe',
